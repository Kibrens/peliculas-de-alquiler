...
namespace PeliculasDeAlquiler.Helpers
{
    class acceso_BD
    {
        ...
        string cadena_conexion = "Provider=SQLNCLI10;workstation id=pav1-db.mssql.somee.com;packet size=4096;user id=milizc_SQLLogin_1;pwd=2s9o1yeexo;data source=pav1-db.mssql.somee.com;persist security info=False;initial catalog=pav1-db";
