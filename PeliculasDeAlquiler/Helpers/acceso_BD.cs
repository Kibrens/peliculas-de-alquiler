...
namespace PeliculasDeAlquiler.Helpers
{
    class acceso_BD
    {
        ...
        string cadena_conexion = "Provider=SQLNCLI11;workstation id=pav1-db.mssql.somee.com;packet size=4096;user id=blosin_SQLLogin_1;pwd=in5wbvgd6s;data source=BaseJoel.mssql.somee.com;persist security info=False;initial catalog=BaseJoel";
